...
<header id="header" class="header d-flex align-items-center sticky-top" style="width: 100%; padding: 20px 0;">
    <div class="container-fluid position-relative d-flex bg-info align-items-center">

      <a href="index.html" class="logo d-flex align-items-center me-auto">
        <h1 class="sitename">E-VOTING</h1>
      </a>
  ...
  <ul class="d-flex align-items-center">
    <li class="d-flex align-items-center">
      ...
      <a href="/login" class="seccondary">Login</a>
    </li>
  </ul>
