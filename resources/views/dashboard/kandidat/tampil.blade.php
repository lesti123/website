            ...
            @foreach ($kandidat as $post)
                <div class="col-md-3 mb-4">
                    <div class="card h-100">
                        <img src="{{ asset('storage/'.$post->foto) }}" class="card-img-top"class="btn btn-primary" alt="Foto {{ $post->nama }}" style="height: 200px; object-fit: cover;">
                        <div class="card-body">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p><strong>NIS:</strong> {{ $post->nis }}</p> <!-- Pastikan ada field nis di model kandidat -->
